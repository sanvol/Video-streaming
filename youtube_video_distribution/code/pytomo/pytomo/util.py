...
class YoutubeHelper:
    ...
    URL_PREFIX = 'https://www.youtube.com/watch'
    VIDEO_QUERY_PARAM = 'v'
    ...
    def api_response_to_video_url_list(api_json_response):
        ...
        urls = map(lambda x: YoutubeHelper.youtube_json_schema_to_url(x), api_json_response['items'])
        return list(urls)

    @staticmethod
    def youtube_json_schema_to_url(schema):
